...
func main() {
	configPath := flag.String("config_path", "/Users/purplecity/test/kryptos_rai/pool_watch/", "config file")
	logFile := flag.String("log_file", "/Users/purplecity/test/kryptos_rai/pool_watch/pool_watch.log", "log file")
