...
import (
	...
	"kryptos_rai/block_parse/simple_internal_tx/bsc/logic"
...
func main() {
	configPath := flag.String("config_path", "/Users/purplecity/test/kryptos_rai/simple_internal_tx/bsc/", "config file")
	logFile := flag.String("log_file", "/Users/purplecity/test/kryptos_rai/simple_internal_tx/bsc/simple_internal_tx_bsc.log", "log file")
	...
	mongo.InternalTxClient = txCli

	logic.BSCInit()
	go logic.GetInternalTx()
